                            ...
                            <table id="products" class="ashik table table-bordered table-striped">
                                ...
                                @foreach($charges as $order)
                                    <tr>
                                        ...
                                        <td>
                                            @if($order['status']==1)
                                                <button class="btn btn-sm btn-success"><a class="check text-white" id="check-{{$order['id']}}" check_id="{{$order['id']}}" url="product"> Active </a></button>
                                            @elseif ($order['status']==0)
                                                <button class="btn btn-sm btn-danger"><a class="check text-white" id="check-{{$order['id']}}" check_id="{{$order['id']}} " url="product"> Inactive </a></button>
