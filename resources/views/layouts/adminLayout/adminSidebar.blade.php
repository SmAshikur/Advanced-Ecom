<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('images/admin/'.Auth::guard('admin')->user()->image)}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            @if(Session::get('page')=='settings'||Session::get('page')=='updateAdmin')
                <?php $active ="active" ?>
            @else
                <?php $active ="" ?>
            @endif
            <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                    @if(  Session::get('page')=='updateAdmin')
            ...
            @if(Session::get('page')=="order"||Session::get('page')=="coupon"||Session::get('page')=='sections'||Session::get('page')=="category"||Session::get('page')=="products"||Session::get('page')=="brand"||Session::get('page')=="banner")
                <?php $active ="active" ?>
            @else
                <?php $active ="" ?>
            @endif
