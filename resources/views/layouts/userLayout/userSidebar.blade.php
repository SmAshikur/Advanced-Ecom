...
<div id="sidebar" class="span3">
    <div class="well well-small"><a id="myCart" href="{{url('cart')}}"><img src="themes/images/ico-cart.png" alt="cart"><span class="totalCart">[ {{totalCartItems()}} ]</span> Items in your cart</a></div>
