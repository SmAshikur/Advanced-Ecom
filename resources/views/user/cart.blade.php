    ...
    <div class="span9">
       ...
       <div id="AppendCart" >
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>
                    <form class="form-horizontal" id="applyCop" method="post" action="javascript:void(0);" @if(Auth::check()) user="1" @endif > @csrf
                        <div class="control-group">
                            <label class="control-label"><strong> COUPON CODE: </strong> </label>
                            <div class="controls">
                                <input id="code" name="code" type="text" class="input-medium" placeholder="Enter Coupon code" required>
